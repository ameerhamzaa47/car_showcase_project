...
//   return (
//     <>
//       <section className='bg-white shadow-lg rounded-lg overflow-hidden lg:w-[200%] transform transition duration-500 hover:scale-105'>
        
//         <div className='py-4 px-8 text-justify text-gray-700'>
//           <q className='font-medium'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Labore incidunt dicta sit illo molestiae, corrupti quo temporibus ducimus aliquid ullam, inventore earum officiis error laboriosam hic? Rem nisi provident incidunt?</q>
//         </div>

//         <div className='px-5 pt-4 flex items-center space-x-4 justify-end'>
