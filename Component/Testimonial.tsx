...
<div className="px-8 pt-12 lg:px-16">
      ...
      <section className="pb-20 pt-20 lg:pb-5 lg:pt-16">
        <div className="container mx-auto">
          <Swiper slidesPerView={1} ref={sliderRef}>
            ...
            <div className="absolute left-0 right-0 z-10 flex items-center justify-end mr-20 shadow-2xl gap-5 sm:bottom-0">
