        ...
        <div className="container mx-auto px-4 py-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div className="bg-white rounded-lg shadow-md overflow-hidden">
                    <img src="/hero.png" alt="Car 1" className="w-full h-48 object-cover"/>
                    <div className="p-4">
                ...
                <div className="bg-white rounded-lg shadow-md overflow-hidden">
                    <img src="/model-icon.png" alt="Car 2" className="w-full h-48 object-cover"/>
                    <div className="p-4">
                ...
                <div className="bg-white rounded-lg shadow-md overflow-hidden">
                    <img src="/tire.svg" alt="Car 3" className="w-full h-48 object-cover"/>
                    <div className="p-4">
